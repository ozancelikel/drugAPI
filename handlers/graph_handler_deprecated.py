...
class GraphHandler:
    def __init__(self, uri: str, auth: tuple):
        self.__graph = Graph(f"{uri}")

    def add_new_relation(self, node_1_lbl: str, node_2_lbl: str, level: list):
...
gh = GraphHandler("neo4j://localhost:7474", ("neo4j", "123456"))
gh.add_new_relation("zaa", "yaa", [{"interactionLevel": "SEVERE"}])
print(gh.get_node("zaa"))
